...
public class Menu extends CssLayout {
    ...
    public Menu(Navigator navigator) {
        ...
        var title = new Label("My CRUD");
        title.addStyleName(ValoTheme.LABEL_H3);
        title.setSizeUndefined();
        var image = new Image(null, new ThemeResource("img/table-logo.png"));
        ...
        var showMenu = new Button("Menu", event ->  {
    ...
    private void createViewButton(final String name, String caption,
            Resource icon) {
        var button = new Button(caption, event -> {
    ...
    public void setActiveView(String viewName) {
        ...
        var selected = viewButtons.get(viewName);
        if (selected != null) {
